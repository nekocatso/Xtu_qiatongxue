...
def process_json(uid,end) :
    ...
    #     # a=time.strftime("%H:%M:%S", time.localtime(step["startTime"]//1000))
    #     # b = time.strftime("%H:%M:%S", time.localtime(step["endTime"]//1000))
    #     a=step["startTime"]
    #     b=step["endTime"]
    #     i=i+1
    #     print(i,a,b,step["timeUsed"])
    # print(data["startTime"],data["endTime"],data["timeUsed"])
...
def first(uid):
    url="https://virtualcourse.zhihuishu.com/report/queryUserName?uuid="+uid+"&courseId=2000077162&"
    headers={
        "Host": "virtualcourse.zhihuishu.com",
        "Connection": "keep-alive",
        "sec-ch-ua" : """" Not A;Brand";v="99", "Chromium";v="100", "Google Chrome";v="100" """,
